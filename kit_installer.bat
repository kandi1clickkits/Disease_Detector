...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/Disease_Detector/releases/download/v1.0.0/Disease-Detector.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/Disease_Detector/raw/main/requirements.txt
SET REPO_NAME=Disease-Detector.zip
SET EXTRACTED_REPO_DIR=Disease-Detector
SET NOTEBOOK_NAME=demo.ipynb
where /q python
IF ERRORLEVEL 1 (
	ECHO==========================================================================
